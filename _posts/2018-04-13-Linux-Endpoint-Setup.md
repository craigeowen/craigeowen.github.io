...
The Labs page Reource section has links to the resource files used throughout the various lab, or alternatively go directly to <a href="https://github.com/craigeowen/my-network-ansible_playbooks">my-network-ansible_playbook</a> GitHub repository.
